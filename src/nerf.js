...
function main() {
    ...
    <video class="centered" width="100%" autoplay="" muted="" loop="" playsinline="">
            ...
            root.innerHTML += `<video class="centered" width="100%" autoplay="" muted="" loop="" playsinline="">
    <source src="https://nvlabs.github.io/instant-ngp/assets/nerf_grid_lq.mp4" type="video/mp4">
    Your browser does not support the video tag.
</video>`

root.innerHTML += `<video class="centered" width="100.0%" autoplay="" muted="" loop="" playsinline="">
