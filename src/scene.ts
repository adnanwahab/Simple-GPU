...
export default class Scene {
  ...
  readonly quads = [
    ...box({
      ...
      rotation: 0,
      color: [
        vec3.fromValues(0.0, 0.0, 0.5), // PositiveX g
        vec3.fromValues(0.5, 0.5, 0.7), // PositiveY gray
        vec3.fromValues(0.5, 0.5, 0.7), // PositiveZ gray
        vec3.fromValues(0.0, 0.0, 0.5), // NegativeX red
        vec3.fromValues(0.5, 0.5, 0.7), // NegativeY gray
        vec3.fromValues(0.5, 0.5, 0.7), // NegativeZ grey
      ],
      type: 'concave',
    }),
    ...box({
